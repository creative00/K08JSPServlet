...
<body>
	...
	items에 지정한 컬렉션에 저장된 객체의 갯수만큼 반복해
	list로 하나씩 전달한다. -->
	<c:forEach items="${ lists }" var="list">
	<!-- EL통해 객체의 멤버변수에 저장된 값을 출력한다.  -->
	<li>
	...
	<h4>Java코드를 통한 출력</h4>
	<%
	/* Java코드를 사용하면 출력할 객체를 명시하고, 
	getter()메서드를 직접 호출해야 한다.*/
	for(Person p: lists){
	...
	<!-- Map컬렉션 사용 시 key를 별도로 얻어올 필요 없이 
	객체.key 혹은 객체.value 통해 값을 출력할 수 있다.  -->
