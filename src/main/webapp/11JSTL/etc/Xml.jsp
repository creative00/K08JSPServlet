...
<!--
 ...
 -->
	...
	<!--booklist하위 노드에는 2개의 book이 있으므로
	인덱스 통해 접근 후 데이터를 파싱한다.  
	이와 같이 XML문서를 마치 경로처럼 접근하는 것을 XPath라 한다.
