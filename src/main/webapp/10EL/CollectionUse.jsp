...
<ul>
	...
	<!-- Person객체를 출력한다. 멤버변수명 통해 getter()를 호출해 출력한다. 
	만약 펄슨클래스에 게터가 정의되지 않으면 PropertyNotFoundException발생하게 된다 -->
	<li>1번째 요소 : ${ Ocean[1].name }, ${ Ocean[1].age }</li>
	<!--2번 인덱스에는 아무런 값도 없으므로 출력되지 않는다.
	Java코드라면 예외가 발생하지만 EL에서는 기본적인 예외는 발생하지 않는다.  -->
	<li>2번째 요소 : ${ Ocean[2] }</li>
</ul>
<h2>Map 컬렉션</h2>
<%
Map<String, String> map = new HashMap<String, String>();
//한글을 key로 설정해 값을 저장한다.
map.put("한글", "훈민정음");
//영문을 key로 사용한다.
map.put("Eng", "English");
//페이지 영역에 저장한다.
