...
<body>
	<!--
	폼값으로 전송된 파라미터를 받을 때 EL의 내장객체 사용 가능.
	param : 단일값을 받을 때 사용
	paramValues : 2개 이상의 값을 받을 때 사용.
			단 이 경우 배열을 통해 값을 구분해야 함
	  -->
	<h3>EL로 폼값 받기</h3>
	<ul>
		<li>이름 : ${ param.name }</li>
		...
		EL은 NullPointException이 발생하지 않으므로 
		아래와 같이 기술해도 문제 없다. -->
	...
	/*
	JSP 내장 객체를 통해 폼값을 받은 후 출력하는 경우
	선택된 값이 1개밖에 없다면 예외가 발생하게 된다.
	이 경우 if문으로 값의 유무를 체크하거나 예외처리를
