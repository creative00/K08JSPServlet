...
<!--정적메서드가 아닌 일반적 메서드는 객체를 통해 호출해야 하므로
객체 생성 후 EL에서 접근할 수 있도록 영역에 저장한다.  -->
<%
...
<head>
<meta charset="UTF-8">
<title>표현 언어(EL) - 메서드 호출</title></head>
<body>
	<!-- 일반적인 메서드 호출 -->
	...
	<!-- 정적메서드의 경우 객체 생성없이 클래스명 직접 호출 가능  -->
	<h3>클래스명을 통해 정적 메서드 호출하기</h3>
	${ MyELClass.showGugudan(7) }
	
	<h3>JSP 코드 통해 메서드 호출하기</h3>
	<%
